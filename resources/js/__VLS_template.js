import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name } from './table.vue';
...
({} as __VLS_IntrinsicElements).th; ({} as __VLS_IntrinsicElements).th; ({} as __VLS_IntrinsicElements).th; ({} as __VLS_IntrinsicElements).th; ({} as __VLS_IntrinsicElements).th; ({} as __VLS_IntrinsicElements).th;
({} as __VLS_IntrinsicElements).tbody; ({} as __VLS_IntrinsicElements).tbody;
({} as __VLS_IntrinsicElements).td; ({} as __VLS_IntrinsicElements).td; ({} as __VLS_IntrinsicElements).td; ({} as __VLS_IntrinsicElements).td; ({} as __VLS_IntrinsicElements).td; ({} as __VLS_IntrinsicElements).td;
{
const __VLS_0 = ({} as __VLS_IntrinsicElements)["table"];
const __VLS_1 = __VLS_elementAsFunctionalComponent(__VLS_0);
({} as __VLS_IntrinsicElements).table;
({} as __VLS_IntrinsicElements).table;
const __VLS_2 = __VLS_1({ ...{}, class: ("table table-striped"), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_0, typeof __VLS_2> & Record<string, unknown>) => void)({ ...{}, class: ("table table-striped"), });
const __VLS_3 = __VLS_pickFunctionalComponentCtx(__VLS_0, __VLS_2)!;
let __VLS_4!: __VLS_NormalizeEmits<typeof __VLS_3.emit>;
{
const __VLS_5 = ({} as __VLS_IntrinsicElements)["thead"];
...
{
const __VLS_10 = ({} as __VLS_IntrinsicElements)["tr"];
...
{
const __VLS_15 = ({} as __VLS_IntrinsicElements)["th"];
...
{
const __VLS_25 = ({} as __VLS_IntrinsicElements)["th"];
...
{
const __VLS_30 = ({} as __VLS_IntrinsicElements)["tbody"];
...
{
const __VLS_50 = ({} as __VLS_IntrinsicElements)["td"];
...
(__VLS_ctx.user.candidate_id > 0 ? "Sudah Memilih" : "Belum Memilih");
